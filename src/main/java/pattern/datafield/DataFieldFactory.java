...
public class DataFieldFactory {
	...
	private static final Logger LOG = LoggerFactory
			.getLogger(DataFieldFactory.class);

	/**
	 * Create the appropriate DataField object based on parsing the data
	 * dictionary in a PMML file.
	 * 
	 * @param reader
	 * @param node
	 * @param name
	 ...
	 */
	public static DataField getDataField(XPathReader reader, Node node,
			String name, String op_type, String data_type)
			throws PatternException {
		DataField df = null;
