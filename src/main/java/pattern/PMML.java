...
public class PMML {
	...
	public enum Models {
		UNKNOWN, MINING, TREE, REGRESSION, CLUSTERING, GENERALIZED_REGRESSION
	};
	...
	public PMML(Reader pmmlSource) throws PatternException {
		...
		version = ((Element) getNodeList("/PMML").item(0))
		...
		schema.parseDictionary(this,
				getNodeList("/PMML/DataDictionary/DataField"));
	}
	...
	public Models parseModelType() {
		...
		else if (reader.read("/PMML/GeneralRegressionModel",
