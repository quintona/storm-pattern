...
public class NumericPredictor extends Predictor {
	...
	private static final Logger LOG = LoggerFactory
			.getLogger(NumericPredictor.class);
	...
	public double calcTerm(Map<String, Object> param_map) {
		...
		LOG.debug(String.format("calc: %s, %e, %e, %e, %e", name, value,
	...
	public String toString() {
		return String.format("NumericPredictor: %s, %e, %e", name, exponent,
				coefficient);
	}
}
